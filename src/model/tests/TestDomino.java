...
public class TestDomino {
	...
	public static void printTest(String heading, Domino d, Domino d2) {
		...
		System.out.println("comparison = " + d.compareTo(d2));
		...
		System.out.println("Flipped comparison = " + d.compareTo(d2));
		...
		System.out.println("comparison = " + d2.compareTo(d));
		...
		System.out.println("Flipped comparison = " + d2.compareTo(d));
